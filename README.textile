...
There's one command-line utility so far: acq_to_mat. It creates a Matlab
file from an AcqKnowledge file.
...
If you want to process the data as NumPy arrays instead, there's an easy
API to work with it:
